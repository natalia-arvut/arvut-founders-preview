/* Shared A4 auto-paginator + Print button for gated partner documents.
   Generalised from /k/nda-198361/nda.js. Lives in the UNGATED site root on purpose:
   subresources of nginx-gated pages (/pmt/*, /diacron/*, ...) do not carry the ?k
   query, so a relative script there is answered by the gate with HTML, not JS
   (same lesson as /doc-lang.js / /hub-*.js). arvut.ch enforces CSP script-src
   'self' — external file required, inline is blocked.
